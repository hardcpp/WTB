...
namespace WTB.SDK.UI
{
    ...
    /// </summary>
    internal static class IncrementSetting
    {
        /// <summary>
        ...
        internal static void Setup(BSMLIncrementSetting p_Setting, BSMLAction p_Action, BSMLAction p_Formatter, float p_Value, bool p_RemoveLabel)
        {
