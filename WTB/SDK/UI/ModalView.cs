...
namespace WTB.SDK.UI
{
    ...
    /// Modal helper class
    /// </summary>
    internal static class ModalView
    {
        /// <summary>
        ...
        /// <returns></returns>
        internal static bool SetupLoadingControl(GameObject p_Modal, out LoadingControl p_LoadingControl)
        {
            ...
            var l_Touchable = p_LoadingControl.GetComponent<Touchable>();
            if (l_Touchable)
        ...
        /// <param name="p_LoadingControl">Instantiated LoadingControl component</param>
        /// <returns></returns>
        internal static bool SetupLoadingControl(HMUI.ModalView p_Modal, out LoadingControl p_LoadingControl)
        {
        ...
        /// <returns></returns>
        internal static bool SetOpacity(GameObject p_Modal, float p_Opacity)
        {
            if (p_Modal == null || !p_Modal)
                return false;

            var l_BG = p_Modal.gameObject.transform.Find("BG");
            var l_Image = l_BG?.GetComponent<ImageView>();
        ...
        /// <param name="p_Opacity">New opacity</param>
        /// <returns></returns>
        internal static bool SetOpacity(HMUI.ModalView p_Modal, float p_Opacity)
        {
