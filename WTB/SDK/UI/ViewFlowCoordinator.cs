...
namespace WTB.SDK.UI
{
    ...
    internal abstract class ViewFlowCoordinator<T> : HMUI.FlowCoordinator
        where T : ViewFlowCoordinator<T>
    {
        ...
        internal void Present(bool p_IgnoreBackuping = false)
        {
            ...
            HMUI.FlowCoordinator l_BackupFlowCoordinator = p_IgnoreBackuping ? null : Resources.FindObjectsOfTypeAll<HMUI.FlowCoordinator>()
                .LastOrDefault(x => x.isActivated && x != this && IsFlowCoordinatorInHierarchy(x));
        ...
        protected void ChangeView(HMUI.ViewController p_NewView, HMUI.ViewController p_Left = null, HMUI.ViewController p_Right = null)
        {
        ...
        /// <returns></returns>
        internal V CreateViewController<V>() where V : HMUI.ViewController
        {
